...
int main(int argc, char **argv){
  ...
  for(int i1=0; i1<=100; ++i1)for(int i2=i1; i2<=100; ++i2)for(int i3=i2; i3<=100; ++i3)for(int i4=i3; i4<=100; ++i4){
    paramsval[0]=(i1-0)*0.05+1.0;
    paramsval[1]=(i2-i1)*0.05+1.0;
    paramsval[2]=(i3-i2)*0.05+1.0;
    paramsval[3]=(i4-i3)*0.05+1.0;
    paramsval[4]=(100-i4)*0.05+1.0;
    RealV newx(dim);
    ...
    if(bestval > val){
      ...
      printf("(%.2lf,%.2lf,%.2lf,%.2lf,%.2lf),%.10lf,%.lf\n", paramsval[0]-1.0, paramsval[1]-1.0, paramsval[2]-1.0, paramsval[3]-1.0, paramsval[4]-1.0, val, dtime);
